...
```bash
wget https://github.com/SoftCreatR/dataloader-for-linux/raw/main/release/nightly/apex-dataloader-54.0.2-1650413397-5eee0c0.deb
```
...
```bash
sudo dpkg -i apex-dataloader-54.0.2-1650413397-5eee0c0.deb
```
<!-- install nightly end -->
