...
```bash
wget https://github.com/SoftCreatR/dataloader-for-linux/raw/main/release/stable/apex-dataloader-56.0.3-1662512637-7bf0d84.deb
```
<!-- download stable end -->
...
```bash
sudo dpkg -i apex-dataloader-56.0.3-1662512637-7bf0d84.deb
```
<!-- install stable end -->
...
```bash
wget https://github.com/SoftCreatR/dataloader-for-linux/raw/main/release/nightly/apex-dataloader-56.0.3-1662163760-7bf0d84.deb
```
...
```bash
sudo dpkg -i apex-dataloader-56.0.3-1662163760-7bf0d84.deb
```
<!-- install nightly end -->
