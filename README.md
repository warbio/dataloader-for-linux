...
```bash
wget https://github.com/SoftCreatR/dataloader-for-linux/raw/main/release/nightly/apex-dataloader-55.0.4-1659658169-522a276.deb
```
...
```bash
sudo dpkg -i apex-dataloader-55.0.4-1659658169-522a276.deb
```
<!-- install nightly end -->
