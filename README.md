...
```bash
wget https://github.com/SoftCreatR/dataloader-for-linux/raw/main/release/nightly/apex-dataloader-54.0.0-1642291567-9efe8ce.deb
```
...
```bash
sudo dpkg -i apex-dataloader-54.0.0-1642291567-9efe8ce.deb
```
<!-- install nightly end -->
