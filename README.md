...
```bash
wget https://github.com/SoftCreatR/dataloader-for-linux/raw/main/release/nightly/apex-dataloader-54.0.0-1644883978-ed3d437.deb
```
...
```bash
sudo dpkg -i apex-dataloader-54.0.0-1644883978-ed3d437.deb
```
<!-- install nightly end -->
