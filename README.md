...
```bash
wget https://github.com/SoftCreatR/dataloader-for-linux/raw/main/release/nightly/apex-dataloader-54.0.1-1649462817-8dadf98.deb
```
...
```bash
sudo dpkg -i apex-dataloader-54.0.1-1649462817-8dadf98.deb
```
<!-- install nightly end -->
