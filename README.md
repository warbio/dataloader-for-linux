...
```bash
wget https://github.com/SoftCreatR/dataloader-for-linux/raw/main/release/nightly/apex-dataloader-56.0.2-1661386242-256da4f.deb
```
...
```bash
sudo dpkg -i apex-dataloader-56.0.2-1661386242-256da4f.deb
```
<!-- install nightly end -->
