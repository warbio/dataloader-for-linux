...
```bash
wget https://github.com/SoftCreatR/dataloader-for-linux/raw/main/release/nightly/apex-dataloader-56.0.1-1661299837-ddc7a09.deb
```
...
```bash
sudo dpkg -i apex-dataloader-56.0.1-1661299837-ddc7a09.deb
```
<!-- install nightly end -->
