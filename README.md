...
```bash
wget https://github.com/SoftCreatR/dataloader-for-linux/raw/main/release/nightly/apex-dataloader-55.0.0-1652746110-ee8ea45.deb
```
...
```bash
sudo dpkg -i apex-dataloader-55.0.0-1652746110-ee8ea45.deb
```
<!-- install nightly end -->
