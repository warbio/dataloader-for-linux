...
```bash
wget https://github.com/SoftCreatR/dataloader-for-linux/raw/main/release/nightly/apex-dataloader-54.0.0-1642982730-20566e8.deb
```
...
```bash
sudo dpkg -i apex-dataloader-54.0.0-1642982730-20566e8.deb
```
<!-- install nightly end -->
