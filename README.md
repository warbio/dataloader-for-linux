...
```bash
wget https://github.com/SoftCreatR/dataloader-for-linux/raw/main/release/nightly/apex-dataloader-56.0.5-1667434270-cd2cb3e.deb
```
...
```bash
sudo dpkg -i apex-dataloader-56.0.5-1667434270-cd2cb3e.deb
```
<!-- install nightly end -->
