...
```bash
wget https://github.com/SoftCreatR/dataloader-for-linux/raw/main/release/nightly/apex-dataloader-54.0.0-1642723502-531c10d.deb
```
...
```bash
sudo dpkg -i apex-dataloader-54.0.0-1642723502-531c10d.deb
```
<!-- install nightly end -->
