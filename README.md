...
```bash
wget https://github.com/SoftCreatR/dataloader-for-linux/raw/main/release/nightly/apex-dataloader-56.0.4-1665965662-f6a9ee7.deb
```
...
```bash
sudo dpkg -i apex-dataloader-56.0.4-1665965662-f6a9ee7.deb
```
<!-- install nightly end -->
