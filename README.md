...
```bash
wget https://github.com/SoftCreatR/dataloader-for-linux/raw/main/release/nightly/apex-dataloader-56.0.0-1660608626-61af994.deb
```
...
```bash
sudo dpkg -i apex-dataloader-56.0.0-1660608626-61af994.deb
```
<!-- install nightly end -->
