...
```bash
wget https://github.com/SoftCreatR/dataloader-for-linux/raw/main/release/nightly/apex-dataloader-56.0.0-1659744642-4508c5e.deb
```
...
```bash
sudo dpkg -i apex-dataloader-56.0.0-1659744642-4508c5e.deb
```
<!-- install nightly end -->
