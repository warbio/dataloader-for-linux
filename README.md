...
```bash
wget https://github.com/SoftCreatR/dataloader-for-linux/raw/main/release/stable/apex-dataloader-56.0.0-1660772712-1ce112a.deb
```
<!-- download stable end -->
...
```bash
sudo dpkg -i apex-dataloader-56.0.0-1660772712-1ce112a.deb
```
<!-- install stable end -->
...
```bash
wget https://github.com/SoftCreatR/dataloader-for-linux/raw/main/release/nightly/apex-dataloader-56.0.0-1660781337-1ce112a.deb
```
...
```bash
sudo dpkg -i apex-dataloader-56.0.0-1660781337-1ce112a.deb
```
<!-- install nightly end -->
