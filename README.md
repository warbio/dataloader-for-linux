...
```bash
wget https://github.com/SoftCreatR/dataloader-for-linux/raw/main/release/nightly/apex-dataloader-54.0.0-1644710762-abc94f8.deb
```
...
```bash
sudo dpkg -i apex-dataloader-54.0.0-1644710762-abc94f8.deb
```
<!-- install nightly end -->
