...
```bash
wget https://github.com/SoftCreatR/dataloader-for-linux/raw/main/release/nightly/apex-dataloader-54.0.0-1642377926-f468b97.deb
```
...
```bash
sudo dpkg -i apex-dataloader-54.0.0-1642377926-f468b97.deb
```
<!-- install nightly end -->
