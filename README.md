...
```bash
wget https://github.com/SoftCreatR/dataloader-for-linux/raw/main/release/nightly/apex-dataloader-56.0.0-1660090135-a1f470b.deb
```
...
```bash
sudo dpkg -i apex-dataloader-56.0.0-1660090135-a1f470b.deb
```
<!-- install nightly end -->
