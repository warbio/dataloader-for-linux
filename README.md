...
```bash
wget https://github.com/SoftCreatR/dataloader-for-linux/raw/main/release/nightly/apex-dataloader-56.0.0-1660176585-a664912.deb
```
...
```bash
sudo dpkg -i apex-dataloader-56.0.0-1660176585-a664912.deb
```
<!-- install nightly end -->
