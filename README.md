...
```bash
wget https://github.com/SoftCreatR/dataloader-for-linux/raw/main/release/stable/apex-dataloader-56.0.5-1666896592-0716398.deb
```
<!-- download stable end -->
...
```bash
sudo dpkg -i apex-dataloader-56.0.5-1666896592-0716398.deb
```
<!-- install stable end -->
...
```bash
wget https://github.com/SoftCreatR/dataloader-for-linux/raw/main/release/nightly/apex-dataloader-56.0.5-1666829450-0716398.deb
```
...
```bash
sudo dpkg -i apex-dataloader-56.0.5-1666829450-0716398.deb
```
<!-- install nightly end -->
