...
<!-- download stable start --> <!-- download stable end -->

2. Install package

<!-- install stable start --> <!-- install stable end -->

## Install (nightly)

1. Download the latest version

<!-- download nightly start --> <!-- download nightly end -->

2. Install package

<!-- install nightly start --> <!-- install nightly end -->
