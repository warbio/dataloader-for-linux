...
```bash
wget https://github.com/SoftCreatR/dataloader-for-linux/raw/main/release/nightly/apex-dataloader-56.0.4-1665792851-572cf34.deb
```
...
```bash
sudo dpkg -i apex-dataloader-56.0.4-1665792851-572cf34.deb
```
<!-- install nightly end -->
