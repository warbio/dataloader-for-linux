...
```bash
wget https://github.com/SoftCreatR/dataloader-for-linux/raw/main/release/nightly/apex-dataloader-54.0.2-1650154092-5eb7aec.deb
```
...
```bash
sudo dpkg -i apex-dataloader-54.0.2-1650154092-5eb7aec.deb
```
<!-- install nightly end -->
