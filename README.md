...
```bash
wget https://github.com/SoftCreatR/dataloader-for-linux/raw/main/release/nightly/apex-dataloader-56.0.4-1664583475-8064766.deb
```
...
```bash
sudo dpkg -i apex-dataloader-56.0.4-1664583475-8064766.deb
```
<!-- install nightly end -->
