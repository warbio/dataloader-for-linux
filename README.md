...
```bash
wget https://github.com/SoftCreatR/dataloader-for-linux/raw/main/release/nightly/apex-dataloader-54.0.2-1649722030-6f2bba4.deb
```
...
```bash
sudo dpkg -i apex-dataloader-54.0.2-1649722030-6f2bba4.deb
```
<!-- install nightly end -->
