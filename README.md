...
```bash
wget https://github.com/SoftCreatR/dataloader-for-linux/raw/main/release/nightly/apex-dataloader-54.0.1-1648080418-0bbdbe8.deb
```
...
```bash
sudo dpkg -i apex-dataloader-54.0.1-1648080418-0bbdbe8.deb
```
<!-- install nightly end -->
