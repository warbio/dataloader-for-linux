...
```bash
wget https://github.com/SoftCreatR/dataloader-for-linux/raw/main/release/nightly/apex-dataloader-56.0.0-1660522192-ca0a2fe.deb
```
...
```bash
sudo dpkg -i apex-dataloader-56.0.0-1660522192-ca0a2fe.deb
```
<!-- install nightly end -->
