...
```bash
wget https://github.com/SoftCreatR/dataloader-for-linux/raw/main/release/nightly/apex-dataloader-54.0.1-1649635734-0a8d280.deb
```
...
```bash
sudo dpkg -i apex-dataloader-54.0.1-1649635734-0a8d280.deb
```
<!-- install nightly end -->
