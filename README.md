...
```bash
wget https://github.com/SoftCreatR/dataloader-for-linux/raw/main/release/nightly/apex-dataloader-54.0.1-1647302802-8ede12d.deb
```
...
```bash
sudo dpkg -i apex-dataloader-54.0.1-1647302802-8ede12d.deb
```
<!-- install nightly end -->
