...
```bash
wget https://github.com/SoftCreatR/dataloader-for-linux/raw/main/release/nightly/apex-dataloader-55.0.3-1658102965-e356ece.deb
```
...
```bash
sudo dpkg -i apex-dataloader-55.0.3-1658102965-e356ece.deb
```
<!-- install nightly end -->
